...
class Content(models.Model):
    ...
    text_number = models.CharField(max_length=20, blank=True, null=True, verbose_name='Порядковый номер')
    quantity = models.IntegerField(verbose_name='Количество')
    note = models.TextField(max_length=250, blank=True, null=True, verbose_name='Примечание')
